 ...
 */
final class Version20241222203033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE player ADD COLUMN photo VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__player AS SELECT id, club_id, nationality_id, first_name, last_name, birth_date, position, jersey_number, world_cups, champions_league, europe_league, national_championship, national_cup, photo_filename, summary FROM player');
        ...
        $this->addSql('INSERT INTO player (id, club_id, nationality_id, first_name, last_name, birth_date, position, jersey_number, world_cups, champions_league, europe_league, national_championship, national_cup, photo_filename, summary) SELECT id, club_id, nationality_id, first_name, last_name, birth_date, position, jersey_number, world_cups, champions_league, europe_league, national_championship, national_cup, photo_filename, summary FROM __temp__player');
