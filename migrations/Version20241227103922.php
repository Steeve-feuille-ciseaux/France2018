 ...
 */
final class Version20241227103922 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Remove createdBy relation from Card entity';
    }

    public function up(Schema $schema): void
    {
        // Drop the foreign key constraint first
        $this->addSql('DROP INDEX IF EXISTS IDX_161498D3B03A8386');
        
        // Create a temporary table without the created_by_id column
        ...
        // Recreate the table without the created_by_id column
        ...
        // Copy the data back
        $this->addSql('INSERT INTO card SELECT id, player_id, club_id, profil_id, visible, summary, notable_action, number, position, image_filename, start_season, end_season, obtenu FROM __temp__card');
    ...
    {
        // Add back the created_by_id column
        $this->addSql('ALTER TABLE card ADD COLUMN created_by_id INTEGER NOT NULL DEFAULT 1');
        $this->addSql('CREATE INDEX IDX_161498D3B03A8386 ON card (created_by_id)');
        $this->addSql('ALTER TABLE card ADD CONSTRAINT FK_161498D3B03A8386 FOREIGN KEY (created_by_id) REFERENCES profil (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        
        // Update created_by_id to be the same as profil_id
        $this->addSql('UPDATE card SET created_by_id = profil_id');
        
        // Remove the default value
        $this->addSql('ALTER TABLE card ALTER COLUMN created_by_id DROP DEFAULT');
    }
}
